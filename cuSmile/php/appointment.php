...
<body>
    ...
    <div class="wrapper">
        <form action="index.php" method="post" class="form-container container p-5">
            <div class="row row-1">
                <div class="col-6">
    ...
    <div class="check-appointment-container">
        <form action="index.php" method="post" class="form-container d-flex flex-column gap-2 w-25 p-2 align-items-center">
