    ...
    <div class="about-section">
        <div style="font-size:20px;padding:10px;margin-bottom:10px;">
            ...
            <div class="scroll-container">
                <div class="scroll-container">
                    <img src="imgs/dental_place.jpg" alt="Cinque Terre" width="600" height="400">
                    <img src="imgs/teeth-white.JPG" alt="Forest" width="600" height="400">
                    <img src="imgs/cleaning.JPG" alt="Northern Lights" width="600" height="400">
                    <img src="imgs/check-up.JPG" alt="Mountains" width="600" height="400">
                  </div>
            </div>
